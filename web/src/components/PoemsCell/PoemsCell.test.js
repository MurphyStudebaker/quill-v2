...
import { Loading, Empty, Failure, Success } from './PoemsCell'
...
describe('PoemsCell', () => {
  ...
  it('Success renders successfully', () => {
    render(<Success userExample={{ poems: { objectKey: 'objectValue' } }} />)
    expect(
      screen.queryByText('{"poems":{"objectKey":"objectValue"}}')
    ).toBeInTheDocument()
  })
})

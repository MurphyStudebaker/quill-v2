...
import { Loading, Empty, Failure, Success } from './PoemsByAuthorCell'

describe('PoemsByAuthorCell', () => {
  afterEach(() => {
    cleanup()
  })
  ...
  it('Success renders successfully', () => {
    render(
      <Success userExample={{ poemsByAuthor: { objectKey: 'objectValue' } }} />
    )
    expect(
      screen.queryByText('{"poemsByAuthor":{"objectKey":"objectValue"}}')
    ).toBeInTheDocument()
  })
})
